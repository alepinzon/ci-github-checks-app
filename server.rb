...
class GHAapp < Sinatra::Application
  ...
  post '/event_handler' do
    ...
    when 'check_run'
      ...
      if @payload['check_run']['app']['id'].to_s === APP_IDENTIFIER
        ...
        when 'created'
          #initiate_check_run
          initiate_check_run_with_failure
        when 'rerequested'
          create_check_run
  ...
  helpers do
    ...
    def initiate_check_run_with_failure
      ...
      if(File.exist?("#{repository}/foo.yml"))
        conclusion = 'success'
        puts 'File exists'
        ...
        annotation = {
              ...
              end_line: 1,
              annotation_level: 'notice',
              message: "Missing Configuration FILE - required file"
        }
      ...
      summary = "Octo HC Workflow summary - Analyzing foo.yml file"
      text = "Octo HC Workflow version: 0.0.1"
      ...
      updated_check_run = @installation_client.patch(
        ...
        {
          accept: 'application/vnd.github.antiope-preview+json',
          name: 'Octo HC Workflow',
          status: 'completed',
          conclusion: conclusion,
          completed_at: Time.now.utc.iso8601,
          output: {
            title: 'Octo HC Workflow',
            summary: summary,
            text: text,
